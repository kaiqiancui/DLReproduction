...
class FuseModule(nn.Module): 
    ...
    def fuse_fn(self, prompt_embeds, id_embeds):
        ...
        stacked_id_embeds = self.mlp1(stacked_id_embeds) + prompt_embeds # 类似残差连接
    ...
    def forward(
        ...
        id_embeds,
        class_tokens_mask, # 用于标识替换位置的token掩码
    ) -> torch.Tensor:
        ...
        valid_id_mask = (
            ...
            < num_inputs[:, None] # 有num_inputs = class_tokens_mask.sum()是有效的
            # 前 num_inputs是T，剩下的是F
        )
